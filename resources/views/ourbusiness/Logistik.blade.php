@php
  ...
  $data = collect($controller::getData())->firstWhere('perusahaan', 'CV Pancoran Bumi Persada');
@endphp
...
<html>
  ...
  <body>
    ...
    <div class="logistik-banner relative w-full h-[220px] sm:h-[280px] md:h-[320px] overflow-hidden fade-section">
      <img src="{{ asset('images/pages/OurBusiness/Logistik.webp') }}" alt="Logistik" class="w-full h-full object-cover">
    </div>
